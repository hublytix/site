    ...
    <main>
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="font-display text-3xl font-bold text-[var(--ink)] mb-2">Privacy Policy</h1>
          ...
          <div className="space-y-6 text-[var(--muted)] text-sm leading-relaxed">
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">1. Who We Are</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">2. Data We Collect</h2>
              <p className="mb-2"><strong className="text-[var(--ink-2)]">Account data:</strong> Your email address and name (from HubSpot OAuth). Used for authentication and communication.</p>
              <p className="mb-2"><strong className="text-[var(--ink-2)]">Portal metadata:</strong> Property definitions, workflow configurations, integration settings, user roles, and aggregate statistics (counts, rates). This is analyzed to produce your health score. We do NOT access or store individual contact records, email content, or deal values.</p>
              <p className="mb-2"><strong className="text-[var(--ink-2)]">Scan results:</strong> Your health scores, category scores, and identified issues are stored to provide historical trending and alerts.</p>
              <p><strong className="text-[var(--ink-2)]">Payment data:</strong> Processed entirely by Stripe. We do not store credit card numbers.</p>
            </div>
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">3. How We Use Data</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">4. Data Storage</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">5. Third-Party Services</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">6. Your Rights</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">7. Cookies</h2>
            ...
            <div>
              <h2 className="text-[var(--ink)] font-display font-semibold text-lg mb-3">8. Changes</h2>
